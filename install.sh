...
DNS="8.8.8.8" # You can add more DNS servers separated by commas, e.g., "8.8.8.8,1.1.1.1"
...
MIN_BYTES=$((200 * 1024**3)) # 200 GiB
MAX_BYTES=$((240 * 1024**3)) # 240 GiB
